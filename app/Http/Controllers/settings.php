...
$redirect_uri = urlencode("https://localhost:44302/");
...
$metadata_endpoint_begin = 'https://'.$tenant.'.b2clogin.com/'.$tenant.'.onmicrosoft.com/v2.0/.well-known/openid-configuration?p=';
